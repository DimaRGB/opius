...
void loadAndPrintAll(const String fileCopy, const String cyclogram,
	TStrings* atrStrings,
	TStrings* paramInfo, TStringGrid* paramGrid,
	TStrings* anlgStrings, TStringGrid* anlgGrid,
	TStrings* snglStrings, TStringGrid* snglGrid,
	TStrings* checkStrings, TChart* chart);
